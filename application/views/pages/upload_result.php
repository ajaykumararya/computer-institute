                   ...
                   <div class="widget-box">
                      ...
                      <div class="widget-body">
                        <div class="widget-main">
                          <form action="" id="upload_result" method="post" class="form-inline" enctype="multipart/form-data">
  ...
  <div class="col-md-12">
    <section class="task-panel tasks-widget">
      ...
      <div class="panel-body">
        ...
        <table class="table table-bordered table-striped table-condensed" id="upload_result_list">
          <thead>
            <tr>
              <th>SR NO.</th>
              <th>IMAGE </th>
