                      ...
                      <div class="widget-box">
                        ...
                        <div class="widget-body">
                          <div class="widget-main">
                            <form action="" method="post" id="add_sub_category"  class="form-inline">
...
<div class="profile-user-info profile-user-info-striped">
                        ...
                        <div class="profile-info-row">
                          ...
                          <div class="profile-info-value">
                            <select class="col-sm-3 col-xs-12 category" name="category">
                        ...
                        <div class="profile-info-row">
                          ...
                          <div class="profile-info-value">
                            <input type="text" name="sub_cat_name" class="col-sm-3 col-xs-12">
                          </div>
                        </div>
