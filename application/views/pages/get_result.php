...
// 		die(var_dump($__R));
		...
		if($stu->num_rows() > 0)
		{
			...
			<div class="row">
			    ...
			    <div class="col-md-12">
			        ...
			        <div class="box-body" id="printableArea" style="position:relative;padding-bottom: 500px;z-index:1">
					    <img src="<?php echo base_url('uploads/');  ?>marksheet.jpg" alt="<?php echo base_url('img/');  ?>MARKSHEET.jpg" style="position: absolute;z-index:-1;width:100%;height:100%;left: 0;">
			...
			<br><br>	<div class="row" style="padding-top:500px;">
				   <table style="width:100%;margin-left:100px;font-size:18px;">
	                    <tbody>
