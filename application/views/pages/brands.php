            ...
            <div class="row mt">
              ...
              <div class="col-lg-12">
                ...
                <div class="form-panel"> 
                          ...
                          <form class="form-horizontal tasi-form" id="add_brand" enctype="multipart/form-data">
                            <?php
                              if($this->uri->segment(3)!= '')
                              {
                                  echo '<input type="hidden" name="brandid" value="'.$this->uri->segment(3).'" >';
                              }
                            ?>
                                ...
                                <div class="form-group ">
                                  ...
                                  <div class="col-lg-10">
                                      <input type="text" name="brand_name" class="form-control" id="inputSuccess" placeholder="TITLE NAME" value="<?php echo @$brand->brand_name; ?>">
                                  </div>
                                </div>
