...
<div class="container solid" id="content">
  ...
  <div >
    ...
    <br>
    <div class="row">
        <table class="table table-bordered border-width" style="width:100%;font-size:11px;">
            <tr>
    ...
    <?php
        ...
        //           <label for="'.$key.'" class="text-capitalize fw-bold">'.$key.': </label>
...
<div>
    <!--<a id="cmd" href="javascript:void(0);" onclick="CreatePDFfromHTML()" class="btn btn-primary float-right"> Download</a>-->
    <a href="<?php echo site_url('printbill/print_form/'.$this->uri->segment(3).' ') ?>" target="_blank" class="btn btn-success pull-right">
