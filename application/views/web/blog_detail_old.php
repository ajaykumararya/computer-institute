<?php
    $blog = $this->db->get_where('blogs', array('BLOG_ID' => $this->uri->segment(2)))->row();
?>    
          ...
          <div class="row">
            ...
            <div class="col-sm-8 col-md-8 wow " >
              <div class="service-box">
                <div class="thumb">
                  <img class="" src="<?php echo base_url('uploads/').$blog->BLOG_IMAGE ?>" style="width:750px; height:400px" alt="">
                </div>
                <div class="details"><br><br>
                  <h3 class="mb-15"><?php echo $blog->BLOG_TITLE ?></h3>
...
<?php
 $blogs=$this->db->query('select * from blogs where PAGE_NAME =  1 and BLOG_STATUS= 1 and BLOG_ID !="'.$this->uri->segment(2).'"');
$blog = $blogs->result();
