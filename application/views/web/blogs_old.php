    ...
    <section>
      <div class="container mt-30 mb-30 pt-30 pb-30">
        <div class="row">
              ...
              <article class="post clearfix mb-0">
                <div class="entry-header">
                    ...
                    //   die(var_dump($this->uri->segment(3)));
                        $num=1;
                        $query = $this->db->get_where('blogs', array('PAGE_NAME' => $num,'BLOG_ID' => $this->uri->segment(3)));
                        $row=$query->row();
                        // echo'<pre>';
                        // die(var_dump($row))
                        
                         ?>
                  <div class="post-thumb thumb"> <img src="<?php echo base_url('uploads/').@$row->BLOG_IMAGE ?>" alt="" class="img-responsive img-fullwidth"> </div>
                </div>
                  ...
                  <div class="entry-meta media no-bg no-border mt-15 pb-20">
                    ...
                    <div class="media-body pl-15">
                      <div class="event-content pull-left flip">
                        <h3 class="entry-title text-white text-uppercase pt-0 mt-0"><a href="blog-single-right-sidebar.html"><?php echo @$row->BLOG_TITLE; ?></a></h3>
                        <!--<span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-theme-colored"></i> 214 Comments</span>                       -->
                        <!--<span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Likes</span>-->
                      </div>
                    </div>
                  </div>
                  <p class="mb-15"><?php echo @$row->BLOG_DESC; ?></p>
              ...
              <div class="widget">
                ...
                <div class="categories">
                  <ul class="list list-border angle-double-right">
                    ...
                    //   die(var_dump($this->uri->segment(3)));
                        $num=1;
                        $blog = $this->db->get_where('blogs', array('PAGE_NAME' => $num));
                        
                        // echo'<pre>';
                        // die(var_dump($row))
                        foreach($blog->result() as $ro){
                         ?>
                    <li><a href="<?php echo site_url('welcome/blogs/').$ro->BLOG_ID;?>"><?php echo $ro->BLOG_TITLE;?><span></span></a></li>
                    <?php } ?>
          ...
          <!--    </div>-->
          <!--    <div class="widget">-->
          <!--      <h4 class="widget-title">Photos from Flickr</h4>-->
