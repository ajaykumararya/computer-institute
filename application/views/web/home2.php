...
?>
    ...
    <section class="divider bg-silver-deep">
      <div class="container pt-50 pb-60">
        <h2 class="package-type text-uppercase line-bottom-centered mb-50 text-header6-color"><?php echo  get_title_name('our_services')->BACK_END_TITLE; ?></h2>
        <div class="row">
   ...
   <section>
      <div class="container pb-50">
        <div class="section-content">
          <div class="row">
            <div class="col-md-4 ">
              <h3 class="text-uppercase line-bottom-theme-colored-2 mt-0 line-height-1"><i class="fa fa-calendar mr-10"></i> <span class="text-theme-colored2"><?php echo  get_title_name('news')->BACK_END_TITLE; ?></span>
              </h3>
            ...
            <div class="col-md-4">
              <h3 class="text-uppercase line-bottom-theme-colored-2 line-height-1 mt-0 mt-sm-30"><i class="fa fa-question-circle-o mr-10"></i>Notice<span class="text-theme-colored2"> Board</span> 
              </h3>
              ...
              <div class="col-md-4">              
              <h3 class="text-uppercase line-bottom-theme-colored-2 mt-0 line-height-1"><i class="fa fa-calendar mr-10"></i><?php echo  get_title_name('event_list')->BACK_END_TITLE; ?><span class="text-theme-colored2"></span></h3>
        ...
        <div class="row ">
          ...
          <div class="col-sm-12 col-md-3">
            <div class="sidebar sidebar-left mt-sm-30">
               <div class="widget">
                <h3 class="text-uppercase mt-0 mt-sm-30"> <span class="text-theme-colored2"> <?php echo  get_title_name('latest_news')->BACK_END_TITLE; ?> </span></h3>
          ...
          <div class="col-sm-12 col-md-6">
              <h3 class="text-uppercase mt-0 mt-sm-30"><?php echo  get_title_name('admission_notice')->BACK_END_TITLE; ?> <span class="text-theme-colored2"><?php echo date('Y'); ?></span> <a href="javascript:void(0)" class="btn btn-danger pull-right btn-xs">View All</a></h3>
              <div class="double-line-bottom-theme-colored-2"></div>
          ...
          <div class="col-sm-12 col-md-3">
           <div class="sidebar sidebar-right mt-sm-30">
                <div class="widget">
                         <h3 class="text-uppercase mt-0 mt-sm-30"> <?php echo  get_title_name('advance_notice')->BACK_END_TITLE; ?> <?php echo date('Y'); ?> <span class="text-theme-colored2"> </span></h3>
              <div class="double-line-bottom-theme-colored-2"></div>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 hvr-float-shadow mb-sm-30">
              <div class="pricing-table bg-silver-deep text-center maxwidth400 pt-10">
                <h2 class="package-type text-uppercase line-bottom-centered mb-50"><?php echo  get_title_name('examination_list')->BACK_END_TITLE; ?></h2>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 hvr-float-shadow mb-sm-30">
              <div class="pricing-table bg-silver-deep text-center maxwidth400 pt-10">
                <h2 class="package-type text-uppercase line-bottom-centered mb-50 " ><?php echo  get_title_name('add_list')->BACK_END_TITLE; ?></h2>
                ...
                <a class="btn btn-lg btn-theme-colored text-uppercase btn-block pt-20 pb-20 btn-flat" href="javascript:void(0);">View All</a>
              </div>
            </div>
            
            <div class="col-xs-12 col-sm-6 col-md-4 hvr-float-shadow mb-sm-30">
              <div class="pricing-table bg-silver-deep text-center maxwidth400 pt-10">
                <h2 class="package-type text-uppercase line-bottom-centered mb-50 "><?php echo  get_title_name('student_corner_list')->BACK_END_TITLE; ?> </h2>
...
?>
    ...
    <section id="reservation" class="parallax layer-overlay bg-theme-header6-background" data-bg-img="<?php echo base_url('uploads/'.$logo->SS_HOME_BANNER2); ?>" data-parallax-ratio="0.4">
      <div class="container">
        <div class="row">
          <div class="col-md-8 sm-text-center">
            ...
            <div class="row mt-0 sm-text-center">
              ...
              <div class="pricing-table bg-silver-deep text-center maxwidth400 pt-10">
                <h2 class="package-type text-uppercase line-bottom-centered mb-50 text-header6-color"><?php echo  get_title_name('information_board')->BACK_END_TITLE; ?></h2>
...
<section id="blog">
    <div class="container pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase title">Latest <span class="text-theme-colored2">Gallery </span><a href="<?php echo site_url('gallery'); ?>" class="btn btn-colored btn-theme-colored2 text-white pull-right btn-sm pl-40 pr-40 mt-15">View All</a></h2>              
              <!--
...
---->
            ...
            <div class="item">
              ...
              <div class="causes bg-white maxwidth500 mb-30">
                ...
                <ul class="list-inline font-20 font-weight-600 clearfix mb-5">
                  ...
                  <li class="pull-left font-weight-400 text-black-333 pr-0">Raised: <span class="text-theme-colored font-weight-700"><i class="fa fa-inr"></i>  <?php echo $row->raised; ?></span></li>

                  <li class="pull-right font-weight-400 text-black-333 pr-0">Goal: <span class="text-theme-colored font-weight-700"> <i class="fa fa-inr"></i> <?php echo $row->goal; ?></span></li>
 ...
 -->
                ...
                <a href="<?php echo base_url(); ?>" class="btn btn-default btn-theme-colored btn-xs font-16 mt-10"><i class="flaticon-charity-make-a-donation font-16 ml-5"></i> <?php echo $row->button_name; ?> <i class="flaticon-charity-make-a-donation font-16 ml-5"></i></a>
...
?>
    ...
    <section class="divider parallax layer-overlay overlay-dark-9" data-bg-img="<?php echo base_url('uploads/'.$logo->SS_HOME_BANNER2); ?>" data-parallax-ratio="0.7">
        ...
        <div class="section-content text-center">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <h2 class="text-white">Just call at <span class="text-white"><?php echo @$profile->ORG_PHONE; ?></span> to make a donation</h2>
          ...
          ?>
            <div class="item">
              <article class="post clearfix mb-30 bg-lighter">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
                    <img src="<?php echo base_url('uploads/').$row->BLOG_IMAGE ?>" alt="" class="img-responsive img-fullwidth"> 
                  </div>
                </div>
                <div class="entry-content border-1px p-20 pr-10">
                  <div class="entry-meta media mt-0 no-bg no-border">
                    ...
                    <div class="media-body pl-15">
                      <div class="event-content pull-left flip">
                        <h4 class="entry-title text-white text-uppercase m-0 mt-5"><a href="<?php echo site_url('welcome/blogs/').@$ro->BLOG_ID;?>"><?php echo @$row->BLOG_TITLE; ?></a></h4>
                  ...
                  <a href="<?php echo site_url('welcome/blogs/').$row->BLOG_ID;?>" class="btn-read-more">Read more</a>
