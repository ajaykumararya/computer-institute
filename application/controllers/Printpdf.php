...
public function print_marksheet()
{
	...
	if($results->result_year){
	    ...
	    $year_name = (numberToRomanRepresentation($results->result_year));
	}else{
        $year_name='';
    }
	/*
    ...
    */
    ...
    $start_year=$row1111->start;
    $end_year=$row1111->end;
...
<body>
            ...
            <div class="row " style="margin-top:-105px;" >
			    ...
			    <div class="col-md-12">
					...
					<div style="position:absolute;z-index:2;left:5.6%;top:71%">
                       $qr_code
                    </div>   
                    <div style="position:absolute;z-index:2;right:8%;top:28%"><img style="height:97px;width:98px;" src="$photo_url"></div>
                    
                    <div class="date" style="position:absolute;bottom:18%;left:7%">
                        <b>ISSUE DATE: $date</b>
                    </div>
			    </div>
