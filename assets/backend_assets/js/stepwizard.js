	...
	$.fn.stepform = function(options) {
		...
		return this.each(function() {
			...
			function buildNavigation(count){
				$this.nav.append("<a class='nav-next btn btn-rounded pink-gradient text-uppercase px-3' data-nav='1'>"+options.navtext.next+"</a>");
				$this.nav.append("<a class='nav-prev btn btn-rounded pink-gradient text-uppercase px-3' data-nav='-1'>"+options.navtext.prev+"</a>");
