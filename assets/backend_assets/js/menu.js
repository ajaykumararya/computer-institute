...
$('ol.sortable').nestedSortable({
    ...
    $('ol.ui-sortable').nestedSortable({
        ...
        tabSize: 15,
        update: function () {
            menu_serialized = $('.dd-list').nestedSortable('serialize');
            //$('#btn-save-menu').attr('disabled', false);
...
$("#save_position").on('submit', function (e) {
    ...
    return false;
        ...
        e.preventDefault();
            $.ajax({
                ...
                data: JSON.stringify($('ol.sortable').nestedSortable('serialize')),
                // dataType: 'JSON',
                contentType: false,
                cache: false,
                processData: false,
